...
<input type={props.type} name={props.name} id={props.name} placeholder = {props.text} value={props.value} onChange={props.change} />  
</div>
)    
}
...
/></div>
<div className="person-info-row"><PersonalInfoInput type = "date" name = "age" value ={props.values.age} change={props.change} text={'Age'} />
</div>
