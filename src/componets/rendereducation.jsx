...
return (
<div className="">
    <h3 style={paddingleft}>{props.value.schoolName}</h3><button type="button" onClick={()=>{props.setAllSchools(props.array.filter((a)=>{return a.id !== props.value.id}))}}>x</button>
